...
from . import amazon, apple, ashby, bytedance, google, greenhouse, lever, meta, microsoft, nvidia, oracle_hcm, placeholder, rippling, tesla, workday, zoom
...
ADAPTERS: dict[str, Adapter] = {
    ...
    "tesla": tesla.fetch_company_jobs,
